...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("\nDetalle de carga:");
        Console.WriteLine("Monto de la demanda: " + montoDemanda + SIMBOLO_PESO1);
        ...
        Console.WriteLine("Precio por entrada: " + SIMBOLO_PESO2 + PRECIO_ENTRADA);
        Console.WriteLine("TOTAL A PAGAR: " + SIMBOLO_PESO2 + subtotalSinIva2);
        ...
        Console.WriteLine("Precio por hora: " + SIMBOLO_PESO3 + PRECIO_HORA);
        Console.WriteLine("TOTAL A PAGAR: " + SIMBOLO_PESO3 + subtotalSinIva3);
        Console.ReadLine();
    }
}